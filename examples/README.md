...
| `14_kintsugi/` | fractured-vessel reassembly (PuzzleFusion++ Port mode) | restoration on Breaking Bad parity data + SYNTHETIC generator chain (`14_kintsugi_synthetic.gh`, no external data) | `14_kintsugi/data/bb_sample_*.bin`; synthetic chain BB-aligned 2026-07-11 (verifier 0.603 / 3 strong); natural network scale (auto-scale off) |
