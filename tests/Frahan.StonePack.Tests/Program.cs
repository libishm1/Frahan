...
var tests = new List<(string Name, Action Body)>
{
    ...
    // Phase 7: Discontinuity ingest (Feature A) + stereonet / block-size (Feature B)
    ("Discontinuity orientation inverse round-trips", DiscontinuityIngestTests.Orientation_RoundTrip),
    ("CSV dip/dipdir header round-trips", DiscontinuityIngestTests.Csv_DipDipDir_Header_RoundTrip),
    ("CSV plane coefficients parse", DiscontinuityIngestTests.Csv_PlaneCoeff),
    ("CSV headerless normals parse", DiscontinuityIngestTests.Csv_Headerless_Normals),
    ("CSV bad row is skipped not thrown", DiscontinuityIngestTests.Csv_BadRow_SkippedNotThrown),
    ("DXF LWPOLYLINE becomes a trace", DiscontinuityIngestTests.Dxf_LwPolyline_Trace),
    ("DXF 3DFACE becomes a plane", DiscontinuityIngestTests.Dxf_3dFace_Plane),
    ("GeoJSON point + line parse", DiscontinuityIngestTests.GeoJson_PointAndLine),
    ("Block size three orthogonal sets Vb=3", DiscontinuityIngestTests.BlockSize_ThreeOrthogonal),
    ("Block size two sets has no volume", DiscontinuityIngestTests.BlockSize_TwoSets_NoVolume),
    ("Block size near-parallel ill-conditioned", DiscontinuityIngestTests.BlockSize_NearParallel_IllConditioned),
    ("Stereonet projection stays within net", DiscontinuityIngestTests.Stereonet_ProjectionRange),
    ("GH Discontinuity Ingest metadata (Rhino)", DiscontinuityIngestTests.Gh_DiscontinuityIngest_Metadata),
    ("GH Stereonet + Block Size metadata (Rhino)", DiscontinuityIngestTests.Gh_StereonetBlockSize_Metadata),
