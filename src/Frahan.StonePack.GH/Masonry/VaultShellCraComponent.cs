...
namespace Frahan.StonePack.GH.Masonry
{
        ...
        : AsyncScanComponent<VaultShellCraComponent.Snapshot, VaultShellCraComponent.Payload>
    {
        ...
        protected override System.Drawing.Bitmap Icon => Frahan.GH.IconProvider.Load("VaultShellCra.png");
        ...
        protected override void RegisterInputParams(GH_InputParamManager p)
        {
            ...
            p.AddIntegerParameter("Hub Mode", "Hm", "Stagger only, hub singularity: 0 = off (granular rings), 1 = single keystone per cone, 2 = split into neighbour-sized wedges (keeps min thickness).", GH_ParamAccess.item, 0);
        }
        ...
        protected override Payload Compute(Snapshot s, CancellationToken token, Action<string> progress)
        {
            ...
            var sa = s.Stagger
                ? VaultShellAssembly.BuildStaggered(quad, s.Thick, s.Density, s.Band, s.MinBlock, s.HubMode)
