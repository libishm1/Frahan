...
public sealed class GeoreferenceByPointsComponent : FrahanComponentBase
{
    public GeoreferenceByPointsComponent()
    ...
    protected override Bitmap Icon => IconProvider.Load("AlignToReference.png");
